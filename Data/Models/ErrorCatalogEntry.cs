...
namespace SQLTriage.Data.Models
{
    ...
    /// SQL health checks from the v2 corpus bundle for contextual remediation.
    /// </summary>
    public sealed class ErrorCatalogEntry
    {
        ...
        /// <summary>Check IDs from the v2 corpus bundle that relate to this error scenario.</summary>
