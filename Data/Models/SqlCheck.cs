...
{
    /// <summary>
    /// Represents a SQLWATCH check configuration sourced from the v2 corpus bundle.
    /// </summary>
    public class SqlCheck
    {
        ...
        /// <summary>
        /// Parsed corpus `remediation:` frontmatter (see <see cref="CheckRemediation"/>). Null
        /// when the check carries no remediation guidance — the common case. Feeds the app's
        /// Remediation UI three-tier contract (corpus-v2/_inventory/REMEDIATION_APP_WIRING_CONTRACT.md).
        /// </summary>
        [JsonPropertyName("remediation")]
        public CheckRemediation? Remediation { get; set; }
    }
}
