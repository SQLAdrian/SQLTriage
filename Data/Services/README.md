...
| Service | Purpose |
|---------|---------|
| AdminAuthService | PBKDF2-SHA256 admin password, session unlock, rate limiting, and first-run setup. No TOTP. |
| InstallProvenanceService | Decides once (and stamps to disk) whether this is a new install — admin gate fails closed — or a pre-upgrade one — gate stays open with a persistent warning |
