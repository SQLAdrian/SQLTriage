...
namespace SQLTriage.Data.Services
{
    ...
    public interface IUserSettingsService
    {
        ...
        /// <summary>Concurrent queries per instance during an audit run. Range 1-16, default 7.</summary>
        int GetAuditMaxConcurrentPerInstance();
        void SetAuditMaxConcurrentPerInstance(int limit);
        ...
        // Fast App Load (instant skeleton screens at the cost of memory)
        bool GetFastAppLoad();
        void SetFastAppLoad(bool enabled);
