...
public static class WaitCategoryClassifier
{
    ...
    public static readonly IReadOnlySet<string> BenignWaitTypes = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
    {
        ...
        "SLEEP_BUFFERPOOL_HELPLW", "SLEEP_DBSTARTUP", "SLEEP_DCOMSTARTUP",
        "SLEEP_DIAG", "SLEEP_MASTERDBREADY",
        "SLEEP_MASTERMDREADY", "SLEEP_MASTERUPGRADED", "SLEEP_MSDBSTARTUP",
        "SLEEP_SYSTEMTASK", "SLEEP_TASK", "SLEEP_TEMPDBSHRINK",
        "SLEEP_TEMPDBSTARTUP", "SLEEP_WORKER", "SLEEP_WORKSPACE_MANAGER",
        "STARTUP_DEPENDENCY_MANAGER", "VDI_CLIENT_OTHER",
