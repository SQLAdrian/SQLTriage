...
public sealed class DocumentationService : IDocumentationService
{
    ...
    private readonly SqlAssessmentService _assessmentService;
    private readonly ILogger<DocumentationService> _logger;
    private readonly IConfiguration _configuration;
    private readonly HttpClient _httpClient;

    /// <summary>
    /// Initialises the DocumentationService with required dependencies.
    /// </summary>
    public DocumentationService(
        IDbConnectionFactory connectionFactory,
        ServerConnectionManager connectionManager,
        IPrintService printService,
        SqlAssessmentService assessmentService,
