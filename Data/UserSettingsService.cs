...
namespace SQLTriage.Data
{
    ...
    public class UserSettingsService : Services.IUserSettingsService
    {
        ...
        public class UserSettings
        {
            ...
            /// <summary>
            /// Set true once the operator has DECLINED the break-glass recovery-password prompt at
            /// the end of onboarding (adminguard-breakglass, 2026-09-01 — the MIDDLE policy Adrian
            /// ruled). While this is true and no recovery password is configured, the recovery
            /// surfaces show a loud, persistent "recovery is unprotected" warning rather than
            /// re-prompting on every visit. Setting a recovery password later makes the warning moot.
            /// </summary>
            public bool RecoveryPasswordPromptDeclined { get; set; } = false;
        ...
        // ── Break-glass recovery-password prompt (adminguard-breakglass) ──
        public bool GetRecoveryPasswordPromptDeclined() { lock (_lock) return _settings.RecoveryPasswordPromptDeclined; }
        public void SetRecoveryPasswordPromptDeclined(bool declined) { lock (_lock) _settings.RecoveryPasswordPromptDeclined = declined; SaveSettings(); }
