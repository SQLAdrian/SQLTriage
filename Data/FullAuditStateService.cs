...
namespace SQLTriage.Data
{
    ...
    public class FullAuditStateService
    {
        ...
        // SelectedConnectionId / SelectedServer MOVED OUT 2026-08-02 to the SCOPED
        // FullAuditViewState. They are the TARGET of a privileged diagnostic run and this
        // service is process-wide, so one caller could retarget another caller's next run.
        // See Data/Services/CircuitViewState.cs.
