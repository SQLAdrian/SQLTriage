        ...
        private void UpdateTrayServerStatus()
        {
            ...
            if (_trayServerCountItem != null && connMgr != null)
            {
                ...
                else if (disconnected == 0)
                {
                    ...
                    _trayServerCountItem.Image = MakeDotIcon(System.Drawing.Color.FromArgb(91, 229, 140)); // #5BE58C — ok
                }
                else if (connected == 0)
                {
                    _trayServerCountItem.Text = $"Servers: 0/{total} connected";
                    _trayServerCountItem.Image = MakeDotIcon(System.Drawing.Color.FromArgb(255, 107, 94)); // #FF6B5E — bad
                }
                else
                {
                    // Mixed — amber
