...
(function () {
    ...
    function readPalette() {
        ...
        var hue  = triple("--cl-hue", "52, 209, 122");      // accent (signal green)
        var edge = triple("--cl-edge-rgb", "91, 229, 140"); // edge/hairline (green-400)
    ...
    // backdrop needs, scoped to this marker class (shared with waveBg.js), so the
    // flat default keeps its solid chrome.
