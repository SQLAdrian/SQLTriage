...
**The audit your CIO can actually defend.** Free, open-source, agentless-by-default SQL Server audit and compliance assessment — 576+ checks, every one of them free, mapped to 30+ compliance frameworks including NIST SP 800-53, CIS, DISA STIG, ISO 27001, SOC 2, PCI-DSS and HIPAA.
...
**Everything in the download is free.** The complete check corpus — 576+ checks — framework mappings throughout, the maturity roadmap, governance scoring, and first-class sp_BLITZ CSV import. No key, no signup, no paywalled checks, use it indefinitely.
...
| Audit-grade checks | **576+ (all free)** | ~150 | ~100 | — |
