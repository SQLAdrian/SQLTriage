...
description: 500+ framework-mapped audit checks for SQL Server. NIST, CIS, STIG, ISO 27001, SOC 2, PCI-DSS, HIPAA. The auditable open alternative to Microsoft SQL Vulnerability Assessment.
---
...
<section class="hero">
  <div class="container hero-inner">
    ...
    <p class="lede">
      <strong>500+ framework-mapped checks</strong> across NIST 800-53, CIS Benchmarks, DISA STIG,
      ...
      <table class="compare-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="col-self yes">10 frameworks</td>
            <td class="no">None</td>
            <td class="no">None</td>
            <td class="no">None</td>
...
<section class="section" id="screenshots">
  <div class="container">
    ...
    <div class="screenshot-grid">
      ...
      <div class="screenshot">
        <img src="screenshots/10-microsoft-sql-vulnerability-assessment.jpg" alt="Vulnerability Assessment — 500+ checks with framework mapping">
...
<section class="section">
  <div class="container">
    ...
    <div class="panel">
      ...
      <p>Microsoft VA covers ~70 checks with no framework mapping, no remediation evidence trail, and no maturity model. SQLTriage covers 500+ checks each cited to a public source and mapped to NIST/CIS/ISO/SOC 2/PCI/HIPAA/FedRAMP controls. The boardroom PDF is the output.</p>
    </div>
    <div class="panel">
