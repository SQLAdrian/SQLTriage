...
namespace SQLTriage.Tests
{
    public class CredentialPorterTests
    {
        ...
        [Fact]
        public void Import_DefaultsConnectionTimeoutToModelDefaultWhenZero()
        {
            var json = """
            {
              "exportedAt": "2026-05-15T00:00:00Z",
            ...
            """;
            // Tracks the ServerConnection model default (not a hard-coded literal).
            Assert.Equal(new ServerConnection().ConnectionTimeout, CredentialPorter.Import(json, "ph")[0].ConnectionTimeout);
        }
