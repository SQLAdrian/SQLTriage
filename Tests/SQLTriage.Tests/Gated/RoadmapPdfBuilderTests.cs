...
namespace SQLTriage.Tests
{
    ...
    public class RoadmapPdfBuilderTests
    {
        ...
        /// <summary>Internal so the sibling gated fixture (Gated/ReportAttestationHonestyTests.cs,
        /// reports-r2-07) renders the same report shape instead of carrying a second copy of it —
        /// the cross-fixture helper convention in Gated/README.md.</summary>
        internal static RoadmapReport Report(double passRate, bool colorBlind = false, bool watermark = false)
        {
            var total = 10;
