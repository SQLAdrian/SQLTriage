...
namespace SQLTriage.Tests
{
    ...
    public class AlertBreakerOutcomeTests
    {
        ...
        public void EvaluationsThatFailInternally_OpenTheBreakerAndKeepItOpen()
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                AlertEvaluationService.ApplyBreakerOutcome(
                    breaker, server, AlertEvaluationService.ServerReachability.Unreachable);
        ...
        public void UndeterminedOutcome_DoesNotResetAnotherSubsystemsOpenCircuit()
        {
            ...
            {
                AlertEvaluationService.ApplyBreakerOutcome(
                    breaker, server, AlertEvaluationService.ServerReachability.Undetermined);
            }
        ...
        public void ReachedServer_StillClosesTheCircuit()
        {
            ...
            AlertEvaluationService.ApplyBreakerOutcome(breaker, server, AlertEvaluationService.ServerReachability.Unreachable);
            AlertEvaluationService.ApplyBreakerOutcome(breaker, server, AlertEvaluationService.ServerReachability.Unreachable);
            AlertEvaluationService.ApplyBreakerOutcome(breaker, server, AlertEvaluationService.ServerReachability.Unreachable);
            Assert.False(breaker.ShouldAttempt(server));

            // A query that actually completed is the one signal entitled to close the circuit.
            AlertEvaluationService.ApplyBreakerOutcome(breaker, server, AlertEvaluationService.ServerReachability.Reached);
        ...
        public void ApplyBreakerOutcome_WithNoBreakerConfigured_IsANoOp()
        {
            ...
            AlertEvaluationService.ApplyBreakerOutcome(null, "srv", AlertEvaluationService.ServerReachability.Unreachable);
        }
        ...
        public void OneServersFailures_DoNotSuppressAnother()
        {
            ...
            {
                AlertEvaluationService.ApplyBreakerOutcome(
                    breaker, "dead", AlertEvaluationService.ServerReachability.Unreachable);
            }
