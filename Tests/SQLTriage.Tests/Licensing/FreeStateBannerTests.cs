...
public class FreeStateBannerTests : IDisposable
{
    ...
    private readonly string _settingsDir =
        Path.Combine(Path.GetTempPath(), "sqlt-freebanner-tests-" + Guid.NewGuid().ToString("N"));
    ...
    /// landed on the developer's real <c>%APPDATA%\SQLTriage\user-settings.json</c>.</para>
    /// </summary>
