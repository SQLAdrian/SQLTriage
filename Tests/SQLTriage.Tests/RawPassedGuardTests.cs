...
namespace SQLTriage.Tests
{
    ...
    public class RawPassedGuardTests
    {
        ...
        private static string BuildMessage(List<string> problems)
        {
            ...
            sb.AppendLine("  • rendering a pass/fail badge?  call CheckClassification.BadgeLabel(r) and");
            sb.AppendLine("                                  BadgeColorVar(r). Do NOT write your own ternary:");
            sb.AppendLine("                                  it must answer WARN *and SKIP and INFO* before it");
            sb.AppendLine("                                  reaches .Passed, and answering only WARN is exactly");
            sb.AppendLine("                                  how Pages/Checks.razor showed a SKIPPED check a");
            sb.AppendLine("                                  green \"✓ pass\" until 2026-09-15.");
