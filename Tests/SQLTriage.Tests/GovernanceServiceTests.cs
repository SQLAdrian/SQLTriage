...
namespace SQLTriage.Tests
{
    public class GovernanceServiceTests
    {
        ...
        public async Task IsBad_HasNoEffectOnScore()
        {
            ...
            var withIsBad = new[]
            {
                new CheckResult { CheckId = "P", Category = "Security", Passed = true,  ScoreWeight = 1, EffortHours = 1, DefinitionFlaggedAdverse = false },
                new CheckResult { CheckId = "F", Category = "Security", Passed = false, ScoreWeight = 1, EffortHours = 1, DefinitionFlaggedAdverse = true }
            };
            var withoutIsBad = new[]
            {
                new CheckResult { CheckId = "P", Category = "Security", Passed = true,  ScoreWeight = 1, EffortHours = 1, DefinitionFlaggedAdverse = false },
                new CheckResult { CheckId = "F", Category = "Security", Passed = false, ScoreWeight = 1, EffortHours = 1, DefinitionFlaggedAdverse = false }
            };
