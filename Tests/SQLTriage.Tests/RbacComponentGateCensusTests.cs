...
namespace SQLTriage.Tests
{
    ...
    public class RbacComponentGateCensusTests
    {
        ...
        /// <summary>
        /// ActivateFullAuditCard is ungated at the component and its register entry justifies that
        /// by naming its host. A justification that names a rendering relationship is prose until
        /// something checks the relationship, and prose is what this lane has died of.
        /// </summary>
        [Fact]
