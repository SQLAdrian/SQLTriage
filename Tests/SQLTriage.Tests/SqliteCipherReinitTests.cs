...
namespace SQLTriage.Tests
{
    ...
    public class SqliteCipherReinitTests : IDisposable
    {
        ...
        // 2026-09-05: the SQLTriage.db row is gone. Its only opener, liveQueriesTableService, was
        // deleted with the panel-provisioning surface, so the store left the registry and a row
        // here would now assert a policy for a store the app never opens.
