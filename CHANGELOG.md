...
>   been 1.0.0.
> - **No entries between `0.85.2` (2026-04-14) and the current `0.92.5`.** Everything from
>   0.86 through 0.92.5 shipped without a changelog entry. `Config/version.json` is the
>   authoritative record of the current version for that span.
