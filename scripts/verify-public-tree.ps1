...
$secretPatterns = @(
    ...
    # The G5 audit's known personal-identifier leak moved to .handoff/.publicclient-deny on
    # 2026-09-20 (gate 4). This script SHIPS, so holding that literal here published the very
    # address it polices - the same reason gates 4 and 5 keep their terms outside this file.
