...
REQUIRED_VERSIONS = ["2008", "2008R2", "2012", "2014", "2016", "2017", "2019", "2022", "2025"]
...
VERSION_MINOR_MAP = {
    ...
    "2016": 0, "2017": 0, "2019": 0, "2022": 0, "2025": 0,
}
    ...
    for ver in REQUIRED_VERSIONS:
        ...
        if lifecycle_urls and ver in lifecycle_urls:
            ...
            url_map = {
                ...
                "2025": "https://learn.microsoft.com/lifecycle/products/sql-server-2025",
            }
            if ver in url_map:
...
def validate_output(output):
    ...
    for ver in REQUIRED_VERSIONS:
        ...
        if build_count == 0:
            ...
            log(f"WARNING: Version '{ver}' has only {build_count} build(s) — expected >=5 (acceptable for a newly-released version)")
